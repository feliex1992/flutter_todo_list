...
import 'infrastructure/core/farebase_injectable_module.dart' as _i14;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt initGetIt({
    ...
    gh.factory<_i11.NoteWatcherBloc>(
        () => _i11.NoteWatcherBloc(gh<_i8.INoteRepository>()));
    gh.factory<_i12.SignInFormBloc>(
        () => _i12.SignInFormBloc(gh<_i6.IAuthFacade>()));
    gh.factory<_i13.AuthBloc>(() => _i13.AuthBloc(gh<_i6.IAuthFacade>()));
    return this;
  }
}
